...
- [ ] GraphicEQ 패널 표시 확인 — 10개 슬라이더(31/63/125/250/500/1k/2k/4k/8k/16kHz) 표시 (수동 확인 필요)
- [ ] 31Hz 슬라이더 +12dB → 서브 저역 강조 확인 (배음 풍부, 저음 두꺼워짐) (수동 확인 필요)
- [ ] 1kHz 슬라이더 +12dB → 해당 주파수 명확히 강조됨 (수동 확인 필요)
- [ ] 16kHz 슬라이더 +12dB → 공기감/존재감 향상 확인 (수동 확인 필요)
- [ ] 500Hz 슬라이더 -12dB → 흐릿한 중역 감소 확인 (수동 확인 필요)
- [ ] FLAT 버튼 클릭 → 전 밴드 슬라이더 즉시 0dB 복귀 (수동 확인 필요)
- [ ] GraphicEQ 블록 ON/OFF 전환 → SignalChainView 반투명/불투명 전환 확인 (수동 확인 필요)
- [ ] GraphicEQ ON/OFF → 소리 차이 즉시 확인 (ON 시 EQ 적용, OFF 시 원음) (수동 확인 필요)

### Chorus (Post-FX)

- [ ] Chorus 블록 ON → 모듈레이션 효과 청취 (소리가 넓어지고 퍼지는 느낌) (수동 확인 필요)
- [ ] Chorus Mix 100% → 강한 모듈레이션 효과, 원음 없이 순수 코러스 (수동 확인 필요)
- [ ] Chorus Mix 0% → 원음 통과, 코러스 효과 없음 (수동 확인 필요)
- [ ] Chorus Rate 최대 → 빠른 피치 변조 확인 (수동 확인 필요)
- [ ] Chorus Rate 최소 → 매우 느린 피치 변조 확인 (수동 확인 필요)
- [ ] Chorus Depth 최대 → 넓은 피치 스윕, 풍부한 코러스 확인 (수동 확인 필요)

### Delay (Post-FX)

- [ ] Delay 블록 ON → 에코 효과 청취 (수동 확인 필요)
- [ ] Delay Time 500ms → 에코가 0.5초 간격으로 들림 (수동 확인 필요)
  - 기대: 베이스 노트를 뚝 끊으면 0.5초 후 동일 노트 에코 청취
- [ ] Delay Feedback 최대 → 에코가 점점 쌓이며 페이드아웃 (수동 확인 필요)
- [ ] Delay Mix 0% → 에코 없이 원음만 (수동 확인 필요)
- [ ] Delay Mix 100% → 원음 없이 에코음만 (수동 확인 필요)

### Reverb (Post-FX)

- [ ] Reverb 블록 ON → 공간감/잔향 확인 (수동 확인 필요)
- [ ] Reverb Room 크기 최대 → 큰 홀 느낌, 긴 잔향 (수동 확인 필요)
- [ ] Reverb Room 크기 최소 → 짧은 잔향, 데드한 공간감 (수동 확인 필요)
- [ ] Reverb Mix 0% → 잔향 없음, 원음만 (수동 확인 필요)

### 신호 체인 전체 흐름

- [ ] Pre-FX → GraphicEQ → Chorus → Delay → Reverb 순서로 신호 체인 확인 (수동 확인 필요)
- [ ] 각 블록 ON/OFF 전환 시 음색 즉시 변화 확인 (수동 확인 필요)
- [ ] Master Volume 0 → 완전 무음 확인 (수동 확인 필요)
