...
- [ ] ⚠️ 팩토리 프리셋 로드 → 파라미터 값 반영 확인 (Phase 8 이후 확인 필요 — PresetManager 미구현)
- [ ] ⚠️ 커스텀 프리셋 저장 → 앱 재시작 → 복원 확인 (Phase 8 이후 확인 필요 — PresetManager 미구현)
- [ ] ⚠️ A/B 슬롯 전환 → 즉시 음색 변화 (Phase 8 이후 확인 필요 — PresetPanel 미구현)
